...
export function canExecuteFastAttack(knightIsAwake) {
  ...
  export function canFreePrisoner(
   ...
   if(knightIsAwake== false){
       if((archerIsAwake == false || archerIsAwake == true)&& prisonerIsAwake == false && petDogIsPresent == false ){
         return(false);
       }
     
         else if(archerIsAwake == false && (prisonerIsAwake == true || petDogIsPresent == true)  ){
         return(true);
         }
